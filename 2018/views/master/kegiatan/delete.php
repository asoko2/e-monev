...
<?php echo form_open('master/kegiatan/delete', ['class'=>'panel form-horizontal']); ?>
    ...
    <div class="panel-body">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-8">
                <input readonly="readonly" type="number" value="<?php _e($data['kode_kegiatan']) ?>" name="kode_kegiatan" class="form-control">
            </div>
        </div>
        <div class="row form-group">
            <label class="col-sm-4 control-label">Nama kegiatan</label>
            <div class="col-sm-8">
                <input readonly="readonly" type="text" value="<?php _e($data['nama_kegiatan']) ?>" name="nama_kegiatan" class="form-control">
            </div>
        </div>
    </div>
