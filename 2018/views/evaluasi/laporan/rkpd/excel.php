...
<table border="0.5pt" style="width:310mm" >
    <thead>
        ...
        <tr>
            ...
            <th rowspan="2" <?php _col(5) ?>>Target Renstra SKPD pada Tahun <?php _e($list_renstra[5]) ?> (Akhir periode renstra SKPD)</th>
            <th rowspan="2" <?php _col(5) ?>>Realisasi capaian kinerja Renstra SKPD sampai dengan Tahun <?php _e($list_renstra[$tahunkey -1]) ?></th>
            ...
            <th rowspan="2" <?php _col(5) ?>>Realisasi Capaian Kinerja dan Anggaran Renja SKPD <?php _e($list_renstra[$tahunkey]) ?> yang dievaluasi</th>
            ...
            <th rowspan="2" <?php _col(5) ?>>Realisasi Kinerja Renstra SKPD s/d Tahun <?php _e($list_renstra[$tahunkey]) ?></th>
            <th rowspan="2" <?php _col(2) ?>>Tingkat Capaian Kinerja Renstra SKPD s/d Tahun <?php _e($list_renstra[$tahunkey]) ?> (%)</th>
