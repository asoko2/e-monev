...
<table width="31cm" border=1 cellspacing=0 cellpadding=3>
	...
	<tr repeat=1>
		...
		<td valign="middle" align="center" rowspan="2" colspan="2">Realisasi Kinerja dan Anggaran RPJMD s/d Tahun <?php echo $config['tahun'] ?></td>
	...
	<tr>
		...
		<td><?php echo persen(($realisasi_kota/$target_kota)*100); ?></td>
		<td colspan="2"></td>
		<td><?php echo persentase(array_sum($rata_kota_on),count($rata_kota_on)) ?></td>
		<td><?php echo persen(($realisasi_kota/$target_kota)*100); ?> </td>
	...
	<tr>
		<td align="right" colspan="19">PREDIKAT KINERJA DARI SELURUH PROGRAM (PROGRAM 1 s.d. PROGRAM <?php echo $nomor_program; ?>)</td>
		<td><?php echo predikatss(array_sum($rata_kota_on),count($rata_kota_on)) ?></td>
		<td><?php echo predikat(($realisasi_kota/$target_kota)*100); ?></td>
		<td colspan="2"></td>
		<td><?php echo predikatss(array_sum($rata_kota_on),count($rata_kota_on)) ?></td>
		<td><?php echo predikat(($realisasi_kota/$target_kota)*100); ?></td>
