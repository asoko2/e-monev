...
<table width="31cm" border=1 cellspacing=0 cellpadding=3>
	...
	<tr><td colspan="25" class="noborder tc"><b>Periode Triwulan <?= $tw?> Tahun <?= $config['tahun'] ?></b></td></tr>
	...
	<tr repeat=1>
		...
		<td valign="middle" width=15 align="center" rowspan="2" colspan="4">Kode</td>
		...
		<td valign="middle" align="center" rowspan="2" colspan="2">Target RPJMD Akhir Periode <?php echo $rpjmd->renstra_awal ?> - <?php echo $rpjmd->renstra_5 ?></td>
		<td valign="middle" align="center" rowspan="2" colspan="2">Realisasi Capaian Kinerja RPJMD s/d Tahun Lalu</td>
		<td valign="middle" align="center" rowspan="2" colspan="2">Target Kinerja dan Anggaran RKPD Tahun Berjalan <?php echo $config['tahun'] ?></td>
		<td valign="middle" align="center" colspan="8">Realisasi Kinerja Pada Triwulan</td>
		<td valign="middle" align="center" rowspan="2" colspan="2">Realisasi Capaian Kinerja dan Anggaran RKPD</td>
		<td valign="middle" align="center" rowspan="2" colspan="2">Tingkat Capaian Kinerja dan Anggaran RKPD Tahun <?php echo $config['tahun'] ?></td>
		<td valign="middle" align="center" rowspan="2" colspan="2">Realisasi Kinerja dan Anggaran RKPD s/d Tahun <?php echo $config['tahun'] ?></td>
		<td valign="middle" align="center" rowspan="2" colspan="2">Tingkat Capaian Kinerja dan Anggaran RPJMD s/d Tahun <?php echo $config['tahun'] ?></td>
	</tr>
	<tr repeat=1>
	...
	<tr repeat=1>
		...
		<td valign="middle" align="center" rowspan="2" colspan="4">3</td>
		<td width=15 valign="middle" align="center" rowspan="2">4</td>
		<td width=20 valign="middle" align="center" rowspan="2">5</td>
	...
	<?php foreach ($per_urusan as $urusan => $per_bidang) :?>
		<?php include 'urusan2.php'; ?>
	<?php endforeach ?>

	<tr>
		<td align="right" colspan="18">JUMLAH ANGGARAN DAN REALISASI DARI SELURUH PROGRAM</td>
	...
	<tr>
		<td align="right" colspan="24">PREDIKAT KINERJA DARI SELURUH PROGRAM (PROGRAM 1 s.d. PROGRAM <?php echo $nomor_program; ?>)</td>
	...
	<tr>
		...
		<td border=0 colspan="23" align="center">
