...
<table border="0.5pt" style="width:310mm" >
    <thead>
        <tr>
            <th colspan="20">FORMULIR 1. EVALUASI HASIL RKPD KABUPATEN BOJONEGORO</th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <th rowspan="2" <?php _col(5) ?>>Target RPJMD pada Tahun <?php _e($list_renstra[5]) ?> (Akhir periode renstra OPD)</th>
            <th rowspan="2" <?php _col(5) ?>>Realisasi capaian kinerja RPJMD sampai dengan Tahun <?php _e($list_renstra[$tahunkey]) ?></th>
