    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th rowspan="2">Target Renstra <br> Tahun <?php _e($tahun) ?></th>
                <th rowspan="2">DPA <br>Tahun <?php _e($tahun) ?></th>
                <th colspan="4">Target pada Triwulan Ke</th>
                <th colspan="4">Realisasi pada Triwulan Ke</th>
            </tr>
            <tr>
                <th>1</th>
                <th>2</th>
                    ...
                    <?php foreach ($bidang as $key => $program): ?><!-- #PROGRAM -->
                        ...
                        <?php foreach ($capaian as $cap): ?>
                            <tr>
                                ...
                                <td class="text-right"><?php _e(_n($cap["t_renstra_$tahunkey"])) ?></td>
                        ...
                        <?php foreach ($program as $kegiatan): ?><!-- #KEGIATAN -->
                            ...
                            <tr>
                               ...
                               <td class="text-right"><?php _e(_n($kegiatan["t_renstra_$tahunkey"])) ?></td>
                            ...
                            <?php foreach ($keluaran as $kel): ?>
                                <tr>
                                    ...
                                    <td class="text-right"><?php _e(_n($kel["t_renstra_$tahunkey"])) ?></td>
...
<script type="text/javascript">
    init.push(function () {
        ...
        $("#select_unit").on("change", function(e) {
            console.log(e.val)
            window.location.href = "<?php echo(site_url("evaluasi/rkpd/index?hash=")) ?>" + e.val
        });
