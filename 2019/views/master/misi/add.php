...
<?php echo form_open('master/misi/add', ['class'=>'panel form-horizontal']); ?>
    <div class="panel-heading">
        <span class="panel-title">Tambah <?php _e($page_title, 'Data Master') ?></span>
    </div>
    <div class="panel-body">
        <div class="row form-group <?php _e($error_class) ?>">
            <label class="col-sm-4 control-label">Kode Misi</label>
            <div class="col-sm-8">
                <input type="number" value="<?php _e($data['id']) ?>" name="id" class="form-control">
                <?php _e($error_text) ?>
            </div>
        </div>
         
        <div class="row form-group">
            <label class="col-sm-4 control-label">Uraian Misi</label>
            <div class="col-sm-8">
