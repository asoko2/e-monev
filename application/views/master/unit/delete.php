...
<?php echo form_open('master/unit/delete', ['class'=>'panel form-horizontal']); ?>
    ...
    <div class="panel-body">
        ...
        <div class="row form-group">
            ...
            <div class="col-sm-8">
                <input readonly="readonly" type="text" value="<?php _e($data['nama_unit']) ?>" name="nama_unit" class="form-control">
            </div>
        </div>
    </div>
    <div class="panel-footer text-right">
        <a href="<?php echo site_url('master/unit') ?>" class="btn btn-primary">Batal</a>&nbsp;&nbsp;<button type="submit" class="btn btn-danger">Hapus</button>
    </div>
<?php echo form_close(); ?>
