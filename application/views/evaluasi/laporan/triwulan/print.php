...
<table border="0.5pt" style="width:310mm" >
    <thead>
        ...
        <tr>
            ...
            <th rowspan="2" <?php _col(5) ?>>Target Renstra Akhir Periode <?php _e($list_renstra[1]) ?> - <?php _e($list_renstra[5]) ?></th>
            <th rowspan="2" <?php _col(5) ?>>Realisasi capaian kinerja Renstra OPD sampai dengan Tahun <?php _e($list_renstra[$tahunkey -1]) ?></th>
            ...
            <th rowspan="2" <?php _col(5) ?>>Realisasi Capaian Kinerja dan Anggaran Renja OPD <?php _e($list_renstra[$tahunkey]) ?> yang dievaluasi</th>
            <th rowspan="2" <?php _col(2) ?>>Tingkat Capaian   Kinerja dan Realissasi Anggaran Renja <?php _e($list_renstra[$tahunkey]) ?> yang dievaluasi (%)</th>
            <th rowspan="2" <?php _col(5) ?>>Realisasi Kinerja Renstra OPD s/d Tahun <?php _e($list_renstra[$tahunkey]) ?></th>
            <th rowspan="2" <?php _col(2) ?>>Tingkat Capaian Kinerja Renstra OPD s/d Tahun <?php _e($list_renstra[$tahunkey]) ?> (%)</th>
