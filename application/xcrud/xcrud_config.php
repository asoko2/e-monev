...
/** Configuration file; f0ska xCRUD v.1.6.25; 10/2014 */
class Xcrud_config
{
    // default connection
    // public static $dbname = 'bojonegoro2018'; // Your database name
    public static $dbname = 'bojonegoro2021'; // Your database name
    public static $dbuser = 'root'; // Your database username
    // public static $dbpass = 'niknok'; // // Your database password
