...
class Keuangan_m extends MY_Model {

    public $table = 'dpa_kegiatan_keuangan';
    public $key = ['tahun','kode_urusan','kode_bidang','kode_unit','kode_subunit','kode_urusan1','kode_bidang1','kode_program','kode_kegiatan'];
